...
def get_tokenizer(model_name):
    ...
    if model_name.startswith(HF_HUB_PREFIX):
        ...
        return None
         ...
         return SiglipProcessor.from_pretrained("google/siglip-so400m-patch14-384").tokenizer
    else:
...
def create_model(
    ...
    if pretrained == 'eva':
        return eva_clip.create_model(model_name=model_name,
                                     ...
                                     precision=precision,
                                     device=device,)
    if pretrained == 'siglip':
        return siglip.create_model(model_name=model_name,
                                     precision=precision,
                                     device=device,)
